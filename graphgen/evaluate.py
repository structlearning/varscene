...
class ArgsEvaluate():
    def __init__(self):
        ...
        ####### set this ##########
        self.model_path = None ## .dat file
        ####### set this ##########
        self.graphs_save_path = None ## directory
        ...
        self.count = 10000
        self.batch_size = 100  # Must be a factor of count
...
def generate_graphs(eval_args):
    ...
    with open(os.path.join(eval_args.current_graphs_save_path, 'gen_graphs.pkl'), 'wb') as f:
